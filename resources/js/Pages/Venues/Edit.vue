...
export default {
    layout: (_h, page) => h(AppLayout, { title: 'Edit venue' }, () => page),
};
</script>
...
const props = defineProps({
    // The venue being edited, shaped by VenueController@edit.
...
<template>
    ...
    <div class="mx-auto max-w-2xl">
        <div class="mb-6">
            <h2 class="font-display text-3xl font-bold tracking-tight">Edit venue</h2>
            <p class="mt-1 text-sm text-ink/60 dark:text-canvas/55">
                Keep the room's details current — update the contacts, fix a number, jot
                down what you learned at the last load-in.
            </p>
        </div>
